    ...
    <nav class="navbar navbar-fixed-top navbar-default navbar-scr">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a style="color: #fff; font-weight: bold;" class="navbar-brand" href="../inicio/index.html">SCR</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <!-- Botao inicio -->
                    <li>
                        <a style="color: #fff;" class="font-navbar" href="../inicio/index.html">Início</a>
                    </li>
                    <!-- Fim botao inicio -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../funcionario/index.html">Funcionários</a></li>
                ...
                <div class="fieldset-card-container">
                    <div class="table-container">
                        <table class="table table-bordered table-hover table-responsive">
                            ...
                            <tr>
                                <td>0002</td>
                                <td>COMISSÃO PEDIDO 0008 RECEBIDA</td>
                                <td>19/09/2019</td>
                                <td>11:45:23</td>
                                <td>0008</td>
                                <td>FUNCIONÁRIO 004</td>
                            </tr>

                            <tr>
                                <td>0003</td>
                                <td>PEDIDO 0003 SAIU PARA ENTREGA</td>
                                <td>18/09/2019</td>
                                <td>08:03:12</td>
                                <td>0003</td>
                                <td>FUNCIONÁRIO 007</td>
